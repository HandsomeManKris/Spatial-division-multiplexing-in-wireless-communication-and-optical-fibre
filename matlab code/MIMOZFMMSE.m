...
semilogy(SNR,ber,'-ks','LineWidth',1);hold on
...
semilogy(SNR,ber,'-bs','LineWidth',1);hold on
...
semilogy(SNR,ber,'--gv','LineWidth',1);hold on
...
semilogy(SNR,ber,'--gx','LineWidth',1);hold on
...
semilogy(SNR,ber,'--rx','LineWidth',1);hold on
grid on;
ylim([10^(-5) 10^(0)])
xlabel('$$SNR$$','Interpreter','latex')
ylabel('BER','Interpreter','latex')
title(' MIMO BER compaison using ZF and MMSE detector ')
legend('16QAM 4X4 channel ZF-MIMO' ,'16PSK 4X4 channel ZF-MIMO' ,'16QAM 4X4 channel MMSE-MIMO' ,'16PSK 4X4 channel MMSE-MIMO' ,'16QAM 8X8 channel ZF-MIMO' ,'16PSK 8X8 channel ZF-MIMO' ,'16QAM 8X8 channel MMSE-MIMO' ,'16PSK 8X8 channel MMSE-MIMO', 'Location','SouthWest')       
 toc       