...
title('8 bits transmission BER of GSM using ML detector and i-MCR detector')
legend('GSM (7,4) 8QAM ML' ,'GSM (8,5) 16QAM ML', 'SM 16X4 16QAM ML','SSK 256X1', 'MMSE-MIMO 4X4 16QAM' ,'GSSK (11,5) ML', 'GSM (7,4) i-MRC','GSM (8,5) i-MRC','Location','NorthEast')       
 toc       
